...
<nav class = "navbar navbar-default">
    ...
    <div id = "myNavbar" class = "collapse navbar-collapse">
        ...
        <ul class = "nav navbar-nav navbar-right rebellion">
            <li> <a href = "index.php"> <span class = "glyphicon glyphicon-home small"> </span> Home </a> </li>
            <li> <a href = "aboutme.php"> <span class = "glyphicon glyphicon-star small"> </span> About Me </a> </li>
            <li> <a href = "contact.php"> <span class = "glyphicon glyphicon-envelope small"> </span> Contact </a> </li>
